...
private:
  ...
  string targetFilename, logname, file_ff;
  FILE* logfile;  
  RandomNumber *mt{};
...
public:
  ...
  System(string targetFilename, string logname, unsigned int nProbe, unsigned int nIter, unsigned int seed, unsigned int nthreads, double dt, double temperatureTarget, unsigned int gas_buffer_flag, unsigned int equipotential_flag, double skin, unsigned int short_range_cutoff, double lj_cutoff, unsigned int long_range_flag, unsigned int long_range_cutoff, double coul_cutoff,
