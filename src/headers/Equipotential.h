...
public:
  Equipotential(MoleculeTarget *moleculeTarget, GasBuffer *gas, unsigned int long_range_flag, double temperature, double mu, double alpha, unsigned int gas_buffer_flag, FILE* logfile);
  ~Equipotential();
