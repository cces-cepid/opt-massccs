...
LinkedCell::LinkedCell(MoleculeTarget *moleculeTarget, double a, double b, double c, 
  double lj_cutoff, double skin, unsigned int long_range_flag, unsigned int long_range_cutoff, double coul_cutoff, unsigned int gas_buffer_flag, FILE* logfile) {
...
fprintf(logfile,"*********************************************************\n");
fprintf(logfile,"Linked-cell: \n");
fprintf(logfile,"Numbers of cells: %i\n", Ncells);
fprintf(logfile,"Nx: %i Ny: %i Nz: %i\n", Nx, Ny, Nz);
fprintf(logfile,"Filled cells: %i\n", filled_cells);
fprintf(logfile,"Empty cells: %i\n", empty_cells);
fprintf(logfile,"Average atoms per cell: %f\n", ((float)average_atoms_cells)/((float)filled_cells));
fprintf(logfile,"Maximum atoms per cell: %i\n", maximum_atoms_cells);
fprintf(logfile,"Minimum atoms per cell: %i\n", minimum_atoms_cells);
fprintf(logfile,"Simulation box: \n");
fprintf(logfile,"lx: %f Ang\n", lx);
fprintf(logfile,"ly: %f Ang\n", ly);
fprintf(logfile,"lz: %f Ang\n", lz);
}
