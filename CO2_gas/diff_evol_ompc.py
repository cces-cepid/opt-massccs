...
#max_bound, min_bound of force field parameters for chemical elements such as: H, C, N, O
elements = []
mass = []
...
for i in range(popsize):
  ...
  os.system('mpirun --np 4 apptainer exec --nv runtime_latest.sif ./build/bin/massccs input.json > log.massccs 2>&1')
